...
public class AnnualPDFExporter extends PDFExporter {
    ...
    public void export() throws FileNotFoundException {
        ...
        //header
        font.setSize(11);
        Paragraph timeStamp = new Paragraph("ออกเมื่อ " + LocalDateTime.now().plusHours(7).format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm")), font);
        ...
        document.add(new Paragraph(String.format("%-20s%27.2f", "รวมน้ำหนัก", summaryDTO.getSumOfWeight()) + "  กก", font));
        document.add(new Paragraph("\n"));
